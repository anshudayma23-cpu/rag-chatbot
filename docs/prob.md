...
## Scope of Work
### 1. Corpus Definition
- **Reference Platform**: Groww
- **Selected AMC**: HDFC Mutual Fund
- **Target Schemes (10 URLs)**:
...
- **Data Source Note**: Currently focusing exclusively on web data from these Groww links. **No official PDFs (factsheets/SID) are provided at this stage.**
