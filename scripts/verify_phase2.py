...
sys.path.append(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "src", "retrieval"))
...
def main():
    try:
        ...
        test_queries = [
            ...
            "Should I invest my 1 Lakh savings in HDFC Defence Fund right now?" # ADVISORY
        ]
